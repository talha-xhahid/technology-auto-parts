...
import '../styles/technologybenefits.css';
...
<div className='technologybenefits' style={{}}> 
    
    <div className='technologybenefits-container'>
        <div className='technologybenefits-left'>
        ...
        <div className='technologybenefits-right'>
        <div className='technologybenefits-image'>
        <div className='technologybenefits-row'>
            <div className='technologybenefits-left'>
            <div
                  style={{
            ...
            <div
                ...
                >
                  ...
                  <div style={{ height: "130px" }} className='technologycardheight'>
                    <h3 className="product-name" style={{ width: "100%", marginTop: "1rem" , lineHeight: "1.2rem",marginBottom:"0.5rem", wordWrap: "break-word",whiteSpace: "normal"}}>
                    Exclusivity
                    </h3>
                    <p className="product-content"
