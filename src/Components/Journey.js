...
const Journey= () => {
    ...
    return(
        <div className='journey'>
            <h4 className="highlight" style={{ textAlign: "center" }}>Technology &nbsp;
        ...
        <div className='journey-container'>
         ...
         <div className='journey-details'>
            ...
            <div className='journey-content'><h3 style={{fontWeight:'500' ,color:'white'}} >2010-Founded</h3><p style={{color:'white',marginTop:'0.8rem',marginBottom:'1.8rem' ,fontSize:'0.9rem'}}>“Technology Auto Parts was founded with a mission to supply high-quality auto parts to repair shops and mobile mechanics across Technology.”</p></div>
         </div>
         <div className='journey-details'>
            <div className='journey-icon'> <img src={icon} style={{height:'20px',width:'20px'}}></img><div className="vertical-line"></div></div>
